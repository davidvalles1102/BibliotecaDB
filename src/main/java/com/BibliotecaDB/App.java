...
public class MediatecaApp extends JFrame {
    ...
    private void agregarMaterial() {
        ...
        if (categoria.equals("Material Escrito")) {
            ...
            String[] tiposAudiovisuales = {"com.BibliotecaDB.CD", "DVD"};
    ...
    private CD agregarCD(String codigo) {
        ...
        int option = JOptionPane.showConfirmDialog(null, message, "Agregar com.BibliotecaDB.CD", JOptionPane.OK_CANCEL_OPTION);
